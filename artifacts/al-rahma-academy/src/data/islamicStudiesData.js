...
export const BOOKS = [
  {
    icon: '📗', title: 'Islamic Creed Series', ar: 'العقيدة في ضوء الكتاب والسنة',
    ...
    link: null, linkLabel: { en: 'Provided in class', ar: 'يُوفَّر في الحصة' },
  },
  {
  ...
  {
    icon: '📙', title: 'Bulugh Al-Maram', ar: 'بلوغ المرام من أدلة الأحكام',
    ...
    link: 'https://sunnah.com/bulugh', linkLabel: { en: 'Read online — Sunnah.com', ar: 'اقرأ أونلاين — Sunnah.com' },
  },
  {
    icon: '📕', title: 'The Sealed Nectar (Ar-Raheeq Al-Makhtum)', ar: 'الرحيق المختوم',
  ...
  {
    icon: '📔', title: 'Ash-Shama\'il Al-Muhammadiyah', ar: 'الشمائل المحمدية',
    ...
    link: 'https://sunnah.com/shamail', linkLabel: { en: 'Read online — Sunnah.com (417 hadiths)', ar: 'اقرأ أونلاين — Sunnah.com (٤١٧ حديثاً)' },
  },
  {
    icon: '📒', title: "Al-Arba'een Al-Nawawiyyah", ar: 'الأربعون النووية',
    ...
    link: 'https://sunnah.com/nawawi40', linkLabel: { en: 'Read all 42 hadiths — Sunnah.com', ar: 'اقرأ الأحاديث الـ ٤٢ — Sunnah.com' },
    libraryNote: { en: '📚 Browse this full collection in our Hadith Library', ar: '📚 تصفح هذا الكتاب كاملاً في مكتبة الحديث' },
  },
  {
    icon: '📓', title: 'Riyad As-Salihin', ar: 'رياض الصالحين',
    ...
    link: 'https://sunnah.com/riyadussalihin', linkLabel: { en: 'Read online — Sunnah.com (1,900 hadiths)', ar: 'اقرأ أونلاين — Sunnah.com (١٩٠٠ حديثاً)' },
  },
  {
    icon: '📋', title: 'Al-Adab Al-Mufrad', ar: 'الأدب المفرد',
    ...
    link: 'https://sunnah.com/adab', linkLabel: { en: 'Read online — Sunnah.com (1,322 hadiths)', ar: 'اقرأ أونلاين — Sunnah.com (١٣٢٢ حديثاً)' },
  },
  {
    ...
    link: 'https://quran.com', linkLabel: { en: 'Read Quran & Tafsir online — Quran.com', ar: 'اقرأ القرآن وتفسيره أونلاين — Quran.com' },
  },
];
