...
export const DB_ASSERTION_CONTRACT = [
  ...
  // coverage). rls.local.test.mjs and upgrade-scenario.local.test.mjs are
  // unchanged in test COUNT (upgrade-scenario's migration-count assertion
  ...
  { name: "acl.local.test.mjs", expectedTotal: 19 },
