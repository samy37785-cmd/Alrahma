...
// Array order below IS the owner-approved display order (Teacher/Contact
// Truth Final Corrective, 2026-09-02): [1, 5, 10, 3, 11, 2, 6, 7, 4, 9, 8].
// Teachers.jsx renders in this array order; TeacherProfile.jsx looks up by
// `id` via TEACHERS.find(), so profile URLs (/academy/teachers/:id) are
// completely unaffected by this order.
