...
export default function HadithLibrary() {
  ...
  useSEO({
    ...
    description: isAr
      ? 'تصفح وابحث في ١٠ كتب من أمهات كتب الحديث النبوي — صحيح البخاري، صحيح مسلم، الأربعون النووية وغيرها.'
      : 'Browse & search 10 authentic hadith collections including Sahih Bukhari, Sahih Muslim, Nawawi 40, and more.',
  });
          ...
          <div className="container">
            ...
            <p className="hl__hero-sub">
              {selected
                ...
                : (isAr
                    ? 'تصفح وابحث في ١٠ كتب من أمهات كتب الحديث النبوي — عربي وإنجليزي — مباشرةً داخل الموقع'
                    : 'Browse & search 10 authentic hadith collections — Arabic & English — all hosted right here'
                  )
              }
            </p>
            {selected && (
                  ...
                  {pageNums.map((n, i) => (
                    <>
                      {i > 0 && pageNums[i - 1] !== n - 1 && (
                        <span key={`gap-${n}`} className="hl__page-gap">…</span>
                      )}
                      <button
                        key={n}
