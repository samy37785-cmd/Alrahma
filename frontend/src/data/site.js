...
// no dependency on an icon webfont that may fail to load under Vite.
export const socials = [
  {
    label: 'Facebook',
    href: 'https://facebook.com/alrahmaacademy',
  ...
  {
    label: 'Instagram',
    href: 'https://instagram.com/alrahmaacademy',
  ...
  {
    label: 'Twitter',
    href: 'https://twitter.com/alrahmaacademy',
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@alrahmaacademy',
