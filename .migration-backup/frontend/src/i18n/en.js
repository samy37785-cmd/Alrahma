const en = {
  ...
  "teacherDash": {
    ...
    "hifz": "Memorization (Hifz)",
    "noCourses": "No course activity yet.",
    "noHifz": "No memorization recorded yet.",
    "delete": "Delete",
    "close": "Close",
    ...
    "cancelClass": "Cancel",
    "classNeed": "Pick a student, title and date.",
  ...
  "parentDash": {
    ...
    "code": "Link code",
    "link": "Link",
    "linked": "Child linked successfully.",
    "children": "My children",
    "noChildren": "No children linked yet.",
    "records": "records",
    "verses": "memorized verses",
    "view": "View progress",
    "unlink": "Unlink",
    "close": "Close",
    "history": "Teacher follow-up",
    "noRecords": "No follow-up records yet.",
    "courseProgress": "Course progress",
    "hifz": "Memorization (Hifz)",
    "noCourses": "No course activity.",
    "noHifz": "No memorization recorded.",
    "surah": "Surah",
    "ayah": "verses",
    "present": "Present",
    "absent": "Absent",
