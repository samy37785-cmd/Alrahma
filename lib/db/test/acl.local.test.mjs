...
async function main() {
  ...
  // -------------------------------------------------------------------
  await test("migration_source_ledger / payment_source_snapshots: PUBLIC/anon/authenticated have NO table privilege at all; service_role has all 4", async () => {
    for (const table of ["migration_source_ledger", "payment_source_snapshots"]) {
