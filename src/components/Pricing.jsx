...
// Discount offer end date — update when promotion changes.
const DISCOUNT_ENDS = new Date('2025-12-31');
...
export default function Pricing() {
  ...
  const showBanner = new Date() < DISCOUNT_ENDS;
          ...
          {plans.map((plan, i) => {
            ...
            >
              ...
              <div className="plan__header" style={{ background: PLAN_GRADS[i % PLAN_GRADS.length] }}>
                ...
                {plan.pricePerHour && (
                  <span className="plan__per-hour">{plan.pricePerHour} {p.perHour}</span>
                )}
                {plan.discountPct && (
