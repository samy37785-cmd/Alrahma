...
export const VALUES_TEXT = {
  ...
  it: [
    ...
    { title: 'Modernità',      desc: 'Uniamo la scienza islamica secolare alla moderna tecnologia online per offrire un\'educazione coranica di livello mondiale direttamente a casa tua.' },
    ...
    { title: 'Trasparenza',    desc: 'Le famiglie ricevono report sui progressi onesti e regolari e una comunicazione aperta lungo tutto il percorso — senza costi nascosti né sorprese.' },
  ],
  es: [
  ...
  de: [
    ...
    { title: 'Modernität',     desc: 'Wir verbinden jahrhundertealte islamische Gelehrsamkeit mit moderner Online-Technologie, um erstklassige Koranbildung direkt zu Ihnen nach Hause zu bringen.' },
  ...
  fr: [
    ...
    { title: 'Modernité',      desc: 'Nous associons une érudition islamique séculaire à la technologie en ligne moderne pour offrir un enseignement coranique de classe mondiale directement chez vous.' },
...
export const TESTIMONIAL_TEXT = {
  ...
  it: [
    ...
    { quote: 'Gli orari flessibili mi hanno permesso di studiare oltre al lavoro. Il mio Tajweed è migliorato più di quanto immaginassi. Altamente raccomandato.', course: 'Tajweed (Hafs)' },
    ...
    { quote: 'Nostra figlia ha memorizzato il suo primo Juz in 3 mesi. La pazienza dell\'insegnante è incredibile — non si scoraggia mai e trova sempre un nuovo modo di spiegare.', course: 'Hifz (Memorizzazione del Corano)' },
    { quote: 'Mi sono convertito 2 anni fa e volevo imparare a leggere il Corano correttamente. Partendo da zero, ora leggo da solo. Alhamdulillah.', course: 'Noorani Qaida per Adulti' },
  ...
  es: [
    ...
    { quote: 'Me convertí hace 2 años y quería aprender a leer el Corán correctamente. Empezando de cero, ahora leo de forma independiente. Alhamdulillah.', course: 'Noorani Qaida para Adultos' },
  ...
  de: [
    { quote: 'Meine Kinder lieben ihren Unterricht. Die Lehrer sind geduldig, freundlich und wirklich kompetent. Wir haben in nur wenigen Monaten erstaunliche Fortschritte gesehen.', course: 'Koran-Lesen & Tadschwid' },
    { quote: 'Die flexiblen Zeiten ermöglichten es mir, neben der Arbeit zu lernen. Mein Tadschwid hat sich mehr verbessert, als ich dachte. Sehr empfehlenswert.', course: 'Tadschwid (Hafs)' },
    ...
    { quote: 'Ich bin vor 2 Jahren konvertiert und wollte lernen, den Koran richtig zu lesen. Von null angefangen, lese ich nun selbstständig. Alhamdulillah.', course: 'Noorani Qaida für Erwachsene' },
  ...
  fr: [
    { quote: 'Mes enfants adorent leurs cours. Les enseignants sont patients, gentils et vraiment compétents. Nous avons constaté des progrès incroyables en quelques mois seulement.', course: 'Lecture du Coran et Tajwid' },
    { quote: 'Les horaires flexibles m\'ont permis d\'étudier en parallèle du travail. Mon Tajwid s\'est amélioré plus que je ne l\'imaginais. Vivement recommandé.', course: 'Tajwid (Hafs)' },
    ...
    { quote: 'Notre fille a mémorisé son premier Juz en 3 mois. La patience de l\'enseignante est incroyable — elle ne se décourage jamais et trouve toujours une nouvelle façon d\'expliquer.', course: 'Hifz (Mémorisation du Coran)' },
    { quote: 'Je me suis converti il y a 2 ans et je voulais apprendre à lire le Coran correctement. Partant de zéro, je lis maintenant de façon autonome. Alhamdulillah.', course: 'Noorani Qaida pour Adultes' },
...
export const INVOICE_TEXT = {
  ...
  de: { locale: 'de-DE', invoice: 'Rechnung', date: 'Datum', period: 'Zeitraum', subscription: 'Abonnement', planWord: 'Tarif', monthlyRate: 'Monatstarif', discount: 'Rabatt', off: 'RABATT', totalPaid: 'Gezahlt insgesamt', paid: '✓ Bezahlt', thankYou: 'Danke, dass Sie mit der Al-Rahma Academy lernen. Möge Allah Ihren Weg segnen.', print: '🖨 Drucken / Als PDF speichern' },
...
export const TOOLS_TEXT = {
  ...
  it: {
    ...
    upcoming: 'prossima ⟵',
    monthShow: '📅 Mostra orario del mese', monthHide: '📅 Nascondi orario del mese',
    ...
    qibla: { title: '🕋 Direzione della Qibla', fromNorth: 'dal Nord', distance: 'distanza dalla Mecca', enableCompass: '🧭 Attiva bussola live (cellulare)', compassLive: '✅ Bussola live attiva — punta il telefono ↑', allowFirst: '📍 Consenti prima la posizione dalla scheda "Orari di Preghiera"', goToPrayer: 'Vai agli Orari di Preghiera ←', kaabaTitle: '🕌 La Sacra Kaaba', kaabaText: 'La Sacra Kaaba è la prima casa eretta per l\'umanità, situata alla Mecca, in Arabia Saudita. I musulmani di tutto il mondo si rivolgono ad essa durante la preghiera. Coordinate: 21.3891° N, 39.8579° E.' },
    cal: { setDate: 'Cerca la tua città nella scheda "Orari di Preghiera" per impostare la data Hijri', monthWord: 'Mese di', upcoming: 'Prossime Ricorrenze Islamiche', ramadan: 'Mese benedetto del Ramadan', eidFitr: 'Eid al-Fitr', eidAdha: 'Eid al-Adha', today: 'Oggi 🎉', days: 'giorni', monthsTitle: 'Mesi Hijri', months: HIJRI_LATIN },
  ...
  es: {
    ...
    upcoming: 'próxima ⟵',
    monthShow: '📅 Mostrar horario del mes', monthHide: '📅 Ocultar horario del mes',
    ...
    qibla: { title: '🕋 Dirección de la Alquibla', fromNorth: 'desde el Norte', distance: 'distancia a La Meca', enableCompass: '🧭 Activar brújula en vivo (móvil)', compassLive: '✅ Brújula en vivo activa — apunta tu teléfono ↑', allowFirst: '📍 Permite primero la ubicación desde la pestaña "Horarios de Oración"', goToPrayer: 'Ir a Horarios de Oración ←', kaabaTitle: '🕌 La Sagrada Kaaba', kaabaText: 'La Sagrada Kaaba es la primera casa erigida para la humanidad, ubicada en La Meca, Arabia Saudita. Los musulmanes de todo el mundo se orientan hacia ella durante la oración. Coordenadas: 21.3891° N, 39.8579° E.' },
    cal: { setDate: 'Busca tu ciudad en la pestaña "Horarios de Oración" para fijar la fecha Hijri', monthWord: 'Mes de', upcoming: 'Próximas Ocasiones Islámicas', ramadan: 'Bendito mes de Ramadán', eidFitr: 'Eid al-Fitr', eidAdha: 'Eid al-Adha', today: 'Hoy 🎉', days: 'días', monthsTitle: 'Meses Hijri', months: HIJRI_LATIN },
  ...
  de: {
    ...
    qibla: { title: '🕋 Qibla-Richtung', fromNorth: 'von Norden', distance: 'Entfernung nach Mekka', enableCompass: '🧭 Live-Kompass aktivieren (Handy)', compassLive: '✅ Live-Kompass an — richte dein Handy aus ↑', allowFirst: '📍 Erlaube zuerst den Standort im Tab „Gebetszeiten“', goToPrayer: 'Zu den Gebetszeiten ←', kaabaTitle: '🕌 Die Heilige Kaaba', kaabaText: 'Die Heilige Kaaba ist das erste für die Menschheit errichtete Haus, gelegen in Mekka, Saudi-Arabien. Muslime weltweit wenden sich ihr beim Gebet zu. Koordinaten: 21.3891° N, 39.8579° O.' },
    cal: { setDate: 'Suche deine Stadt im Tab „Gebetszeiten“, um das Hijri-Datum festzulegen', monthWord: 'Monat', upcoming: 'Bevorstehende islamische Anlässe', ramadan: 'Gesegneter Monat Ramadan', eidFitr: 'Eid al-Fitr', eidAdha: 'Eid al-Adha', today: 'Heute 🎉', days: 'Tage', monthsTitle: 'Hijri-Monate', months: HIJRI_LATIN },
  ...
  fr: {
    ...
    upcoming: 'prochaine ⟵',
    monthShow: '📅 Afficher l\'horaire du mois', monthHide: '📅 Masquer l\'horaire du mois',
    ...
    qibla: { title: '🕋 Direction de la Qibla', fromNorth: 'depuis le Nord', distance: 'distance jusqu\'à La Mecque', enableCompass: '🧭 Activer la boussole en direct (mobile)', compassLive: '✅ Boussole en direct activée — orientez votre téléphone ↑', allowFirst: '📍 Autorisez d\'abord la localisation dans l\'onglet « Horaires de Prière »', goToPrayer: 'Aller aux Horaires de Prière ←', kaabaTitle: '🕌 La Sainte Kaaba', kaabaText: 'La Sainte Kaaba est la première maison érigée pour l\'humanité, située à La Mecque, en Arabie saoudite. Les musulmans du monde entier s\'orientent vers elle pendant la prière. Coordonnées : 21.3891° N, 39.8579° E.' },
    cal: { setDate: 'Cherchez votre ville dans l\'onglet « Horaires de Prière » pour définir la date Hijri', monthWord: 'Mois de', upcoming: 'Prochaines Occasions Islamiques', ramadan: 'Mois béni du Ramadan', eidFitr: 'Aïd al-Fitr', eidAdha: 'Aïd al-Adha', today: 'Aujourd\'hui 🎉', days: 'jours', monthsTitle: 'Mois Hijri', months: HIJRI_LATIN },
