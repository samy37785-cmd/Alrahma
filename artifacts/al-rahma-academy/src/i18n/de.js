...
const de = {
  ...
  "features": {
    ...
    "items": [
      ...
      },
      {
        ...
        "text": "Qualifizierte Lehrerinnen für Schwestern und Kinder."
      },
      {
  ...
  "courses": {
    ...
    "items": [
      ...
      {
        "title": "Rezitation mit Tajweed",
        "text": "Meistere die Tajweed-Regeln für eine schöne und korrekte Koranrezitation.",
        "points": [
          "Alle Tajweed-Regeln (Hafs & Warsh)",
          "Live-Korrektur durch zertifizierten Lehrer",
          "Audio- und Videoübungsmaterialien"
        ]
      },
      {
      ...
      },
      {
        ...
        "text": "Lerne die Grundlagen von Aqeedah, Fiqh, Seerah und der täglichen islamischen Praxis.",
        "points": [
          "5 Module — Aqeedah, Fiqh, Seerah, Hadith, Tafsir",
          "Authentische islamische Primärquellen",
          "In deiner eigenen Sprache unterrichtet"
        ]
      },
      {
        ...
        "points": [
          ...
          "Interaktives In-Browser-Training",
          "Italienische phonetische Entsprechungen"
        ]
      }
    ],
    "meta": [
  ...
  "pricing": {
    ...
    "securePayment": "Wir bestätigen den Endpreis per WhatsApp",
  ...
  "trial": {
    ...
    "placeholders": {
      ...
      "message": "Erzähl uns vom Schüler, Alter, Niveau..."
    },
  ...
  "newsletter": {
    "badge": "Newsletter",
    "heading": "Tajweed-Tipps für Einsteiger",
    "sub": "Praktische Koran- und Tajweed-Hinweise für Einsteiger, direkt in dein Postfach — in einfacher Sprache, ganz ohne Arabisch-Vorkenntnisse.",
    "benefits": [
      "Praktische Tajweed-Hinweise für Einsteiger",
      "Einfach erklärte Aussprachetipps",
      "Ein einfacher Plan für eine tägliche Gewohnheit"
    ],
    ...
    "successSub": "Dein Abonnement ist bestätigt — schau in dein Postfach für Neuigkeiten.",
  ...
  "footer": {
    ...
    "trustBadges": ["24-Tage-Erstattungsfenster", "Al-Azhar-zertifizierte Lehrer", "Schüler aus aller Welt", "Engagiert für qualitativ hochwertigen Unterricht", `Antwort innerhalb von ${siteFacts.supportResponseHours} Stunden`],
    ...
    "items": [
      {
        ...
        "a": "Nein — absolute Anfänger sind herzlich willkommen. Wir beginnen mit dem arabischen Alphabet (Noorani Qaida) und bauen darauf auf. Unsere Lehrer haben Erfahrung mit Schülern aller Altersgruppen und Niveaus."
      },
      {
      ...
      },
      {
        ...
        "a": "Unterricht findet über Zoom oder Skype statt. Beide sind kostenlos und funktionieren auf jedem Gerät. Wir helfen dir gerne bei der Einrichtung vor deiner ersten Stunde."
      },
      {
  ...
  "courseContent": {
    ...
    "needSub": "Du benötigst ein aktives Abonnement, um auf Kursmaterialien zuzugreifen.",
    "viewPlans": "Pläne ansehen",
    "materials": "Kursmaterialien",
    "noMaterials": "Noch keine Materialien hochgeladen. Komm bald wieder!",
    "watch": "Ansehen",
  ...
  "authPg": {
    ...
    "profile": {
      ...
      "passNoMatch": "Neue Passwörter stimmen nicht überein.",
      "passShort": "Das neue Passwort muss mindestens 6 Zeichen lang sein.",
    ...
    "paymentDeprecated": {
      "backToSite": "← Zurück zur Website",
      "title": "Online-Zahlung wird hier nicht mehr verwendet",
      "sub": "Wir bestätigen Buchungen und Zahlungen jetzt per WhatsApp. Sende eine Buchungsanfrage — unser Team meldet sich, um die Zahlung zu vereinbaren.",
      "cta": "Zur Buchung"
    },
    "forgotPwd": {
      ...
      "busy": "Senden…",
      "success": "Prüf deinen Posteingang — wir haben einen Reset-Link gesendet!",
      "back": "← Zurück zur Anmeldung",
      "errorFallback": "E-Mail konnte nicht gesendet werden. Bitte erneut versuchen."
    },
    "resetPwd": {
      "title": "Neues Passwort festlegen",
      "sub": "Gib dein neues Passwort ein und bestätige es.",
      "newPass": "Neues Passwort",
  ...
  "enroll": {
    ...
    "step1": {
      ...
      "country": "Land",
      "city": "Stadt / Region",
      "timezone": "Deine Zeitzone (automatisch erkannt)",
      "available": "Wann bist du verfügbar?",
      "selectAll": "(wähle alle zutreffenden)",
      "selectCountry": "Land auswählen…",
      "placeholderName": "Dein Name",
      "placeholderCity": "z.B. Berlin, Rom, Paris…",
      "slots": {
        "morning": "Morgen",
        "morningSub": "6 – 12 Uhr",
        "afternoon": "Nachmittag",
        "afternoonSub": "12 – 17 Uhr",
        "evening": "Abend",
        "eveningSub": "17 – 22 Uhr",
        "lateNight": "Spätnacht",
        "lateNightSub": "22 – 2 Uhr",
        "weekends": "Wochenende",
        "weekendsSub": "Sa & So"
      }
    },
    "step2": {
      ...
      "level": "Dein Niveau",
      "levelBeginner": "Anfänger — gerade erst anfangen",
      "levelIntermediate": "Mittelstufe — etwas Vorwissen",
      "levelAdvanced": "Fortgeschritten — tieferes Studium",
    ...
    "step4": {
      ...
      "summaryPlan": "Plan",
      "summaryLang": "Sprache",
      "confirmBooking": "Buchungsanfrage bestätigen →"
    },
    "success": {
      "icon": "🎉",
      ...
      "thankYouPre": "Deine Buchungsanfrage ist eingegangen, ",
      "thankYouPost": ". Unser Team wird dich per WhatsApp kontaktieren, um Zeitplan und Zahlung zu bestätigen.",
      "emailNote": "Eine Bestätigung wurde an deine E-Mail gesendet.",
      "bookingRefLabel": "Deine Buchungsreferenz",
      "whatsappCta": "Schreib uns auf WhatsApp",
      "whatsappNote": "Sende die vorausgefüllte Nachricht, damit wir Zeitplan und Zahlung bestätigen können.",
      "whatsappTemplate": "Hallo, ich habe gerade eine Buchungsanfrage bei Al-Rahma Academy gesendet.\nName: {name}\nPlan: {plan}\nBuchungsreferenz: {ref}",
    ...
    "validation": {
      ...
      "whatsappRequired": "Eine WhatsApp-Nummer ist erforderlich, damit wir dich zur Vereinbarung deiner Buchung kontaktieren können.",
  ...
  "adhkar": {
    ...
    "unmarkDone": "Markierung aufheben",
    "tapTitle": "Zum Zählen tippen",
    ...
    "categories": {
      ...
      "masaa": "Abend-Adhkar",
      "nawm": "Schlaf-Adhkar",
      "istiqath": "Aufwach-Adhkar",
      "baadSalah": "Nach dem Gebet",
      "hayat": "Alltag",
      "munasabat": "Anlässe",
      "ruqya": "Ruqyah"
    }
  ...
  "dashboard": {
    ...
    "startLearning": "Lernen starten →",
    "noCoursesMsg": "Wähle einen Plan, um deine Kursmaterialien freizuschalten.",
    "scheduleNote": "Dein Lehrer sendet den Zoom-Link vor jeder Stunde per WhatsApp.",
  ...
  "adminBookings": {
    "title": "Buchungen ({new} neu / {total} insgesamt)",
    "searchPlaceholder": "Suche nach Name, E-Mail oder Buchungsnummer…",
    "colBookingRef": "Buchungsnr.",
    "colName": "Name",
    "colWhatsapp": "WhatsApp",
    "colPlan": "Plan",
    "colStatus": "Status",
    "colAmount": "Vereinbarter Betrag",
    "colDate": "Datum",
    "colDetails": "Details",
    "statusPending": "Neu",
    ...
    "statusPaid": "Bezahlt",
    "statusEnrolled": "Aktiviert",
    "statusCancelled": "Storniert",
    "edit": "Bearbeiten",
    "close": "Schließen",
    "save": "Speichern",
    "saving": "Wird gespeichert…",
    "fieldAgreedAmount": "Vereinbarter Betrag",
    "fieldCurrency": "Währung",
    "fieldPaymentMethod": "Externe Zahlungsmethode",
    "placeholderPaymentMethod": "Überweisung, Bar…",
    "fieldPaidOn": "Bezahlt am",
    "fieldRenewsOn": "Verlängert am",
    "fieldAdminNote": "Admin-Notiz / Referenz",
    "placeholderAdminNote": "Referenz oder interne Notiz",
    "emptyState": "Noch keine Buchungsanfragen.",
    "errorStatusUpdate": "Status konnte nicht aktualisiert werden",
    "errorSaveDetails": "Buchungsdetails konnten nicht gespeichert werden"
  },
  "errors": {
  ...
  "messages": {
    "bar": "Nachrichten",
    "back": "Website ansehen",
    "contacts": "Unterhaltungen",
    "noContacts": "Keine Unterhaltungen verfügbar. Nachrichten laufen zwischen einem Schüler und seinem Lehrer.",
    "pick": "Wähle eine Unterhaltung, um zu chatten.",
    "send": "Senden",
  ...
  "referral": {
    ...
    "waMessage": `🌙 Ich lerne den Koran bei Al-Rahma Academy. Du kannst hier ${trialLessonPhrase('de')} ausprobieren (${siteFacts.trialLessonMinutes} Minuten): `
  }
};
export default de;
