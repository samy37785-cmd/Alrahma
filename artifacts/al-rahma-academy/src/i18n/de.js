...
const de = {
  ...
  "blog": {
    ...
    "loadError": "Artikel konnten nicht geladen werden. Bitte versuche es erneut."
  },
  "notFound": {
  ...
  "authPg": {
    ...
    "paymentDeprecated": {
      "backToSite": "← Zurück zur Website",
      "title": "Online-Zahlung wird hier nicht verwendet",
      "sub": "Al-Rahma Academy nutzt keine Online-Zahlungen. Sende eine Buchungsanfrage — unser Team prüft sie und meldet sich bei dir.",
      "cta": "Zur Buchung"
    },
    "forgotPwd": {
  ...
  "enroll": {
    ...
    "success": {
      ...
      "thankYouPost": ". Unser Team prüft deine Anfrage und kontaktiert dich per WhatsApp, um den Zeitplan zu bestätigen.",
      ...
      "whatsappNote": "Sende die vorausgefüllte Nachricht, damit wir den Zeitplan bestätigen können.",
  ...
  "adminBookings": {
    ...
    "statusAwaitingPayment": "Zahlung ausstehend (alt)",
    "statusPaid": "Bezahlt (alt)",
    ...
    "errorApprove": "Buchung konnte nicht genehmigt werden"
  },
  "errors": {
