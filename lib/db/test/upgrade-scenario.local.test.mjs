...
async function main() {
  ...
  // -------------------------------------------------------------------
  await test("phase 3: apply the full migrations folder — only 0004-0023 actually run", async () => {
    ...
    // partial unique index) — 24 migrations total in the folder now, up
    // from 23. This count tracks the folder's real size, not a number to
    // keep in sync by hand every time a migration is added.
    const expected = 24;
