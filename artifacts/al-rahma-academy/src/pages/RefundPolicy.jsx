...
export default function RefundPolicy() {
  ...
  const policies = {
    ...
    es: {
      ...
      covered: 'Qué está cubierto', coveredItems: ['✅ Todos los planes de suscripción (Starter, Standard, Premium)', '✅ Solo el primer período de facturación', '✅ No se exige un número mínimo de clases', '✅ No hay deducciones por las clases ya asistidas', '✅ Los reembolsos aprobados se devuelven a tu método de pago original — sin “crédito de tienda”'], notCovered: 'Qué no está cubierto', notCoveredItems: ['❌ Solicitudes de reembolso realizadas después de 24 días desde el pago inicial', '❌ Renovaciones mensuales posteriores (solo el primer pago es elegible)', '❌ Clases de prueba gratuitas (gratis = sin pago = no se aplica reembolso)'],
