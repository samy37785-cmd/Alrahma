...
//
// This suite is intentionally standalone (not wired into orchestrate-db-
// tests.mjs's fixed 5-suite pipeline/exact assertion contract — that
// pipeline's contract is a deliberately closed, hand-maintained list; see
// orchestrator-lib.mjs's DB_ASSERTION_CONTRACT). Run directly:
