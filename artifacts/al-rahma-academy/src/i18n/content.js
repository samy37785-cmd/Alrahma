...
export const TOOLS_HUB_TEXT = {
  en: { badges: [{ label: '⭐ Most Popular', cls: 'hub-badge--gold' }, null, null, { label: '🕌 Daily Use', cls: 'hub-badge--green' }, null, { label: '🆕 New', cls: 'hub-badge--blue' }], stats: ['2M+ verses read', '50K+ daily users', '10K+ hadiths accessed', '1M+ prayer times checked', '5M+ tasbeeh counted', '30K+ letters practiced'], cta: { eyebrow: 'Take the next step', heading: 'Love these tools? Learn with a certified tutor.', sub: 'Our free tools are just a glimpse of what you get with Al-Rahma Academy. Join one-to-one lessons with Al-Azhar certified tutors and transform your Quran learning journey.', bullets: ['30-minute free trial lesson — no payment required', 'Personalised curriculum for your level', 'Female tutors available for sisters', 'Flexible scheduling, 24/7'], button: 'Book a Free Trial Lesson', note: 'No credit card · Cancel anytime · Reply within 2 hours', socialProof: 'Join 1,200+ students already learning' } },
  ar: { badges: [{ label: '⭐ الأكثر استخداماً', cls: 'hub-badge--gold' }, null, null, { label: '🕌 للاستخدام اليومي', cls: 'hub-badge--green' }, null, { label: '🆕 جديد', cls: 'hub-badge--blue' }], stats: ['+2 مليون آية مقروءة', '+50 ألف مستخدم يومياً', '+10 آلاف حديث تمّت قراءته', '+1 مليون موعد صلاة تمّت مراجعته', '+5 ملايين تسبيحة تمّ عدّها', '+30 ألف حرف تمّت ممارسته'], cta: { eyebrow: 'خذ الخطوة التالية', heading: 'أعجبتك هذه الأدوات؟ تعلّم مع معلم معتمد.', sub: 'أدواتنا المجانية ليست سوى لمحة مما تحصل عليه مع أكاديمية الرحمة. انضم إلى دروس فردية مع معلمين معتمدين من الأزهر وحوّل رحلة تعلّمك للقرآن.', bullets: ['درس تجريبي مجاني لمدة 30 دقيقة — لا يلزم الدفع', 'منهج شخصي يناسب مستواك', 'معلمات متاحات للأخوات', 'مواعيد مرنة على مدار الساعة'], button: 'احجز درساً تجريبياً مجانياً', note: 'لا حاجة لبطاقة ائتمان · ألغِ في أي وقت · نرد خلال ساعتين', socialProof: 'انضم إلى +1,200 طالب يتعلمون بالفعل' } },
  it: { badges: [{ label: '⭐ Più popolare', cls: 'hub-badge--gold' }, null, null, { label: '🕌 Uso quotidiano', cls: 'hub-badge--green' }, null, { label: '🆕 Novità', cls: 'hub-badge--blue' }], stats: ['2M+ versetti letti', '50K+ utenti giornalieri', '10K+ hadith consultati', '1M+ orari di preghiera controllati', '5M+ tasbeeh contati', '30K+ lettere praticate'], cta: { eyebrow: 'Fai il prossimo passo', heading: 'Ti piacciono questi strumenti? Impara con un insegnante certificato.', sub: 'I nostri strumenti gratuiti sono solo un assaggio di ciò che trovi in Al-Rahma Academy. Partecipa a lezioni individuali con insegnanti certificati di Al-Azhar e trasforma il tuo percorso di apprendimento del Corano.', bullets: ['Lezione di prova gratuita di 30 minuti — nessun pagamento richiesto', 'Programma personalizzato per il tuo livello', 'Insegnanti donne disponibili per le sorelle', 'Orari flessibili, 24/7'], button: 'Prenota una lezione di prova gratuita', note: 'Nessuna carta richiesta · Annulla in qualsiasi momento · Risposta entro 2 ore', socialProof: 'Unisciti a oltre 1.200 studenti che stanno già imparando' } },
  es: { badges: [{ label: '⭐ Más popular', cls: 'hub-badge--gold' }, null, null, { label: '🕌 Uso diario', cls: 'hub-badge--green' }, null, { label: '🆕 Nuevo', cls: 'hub-badge--blue' }], stats: ['2M+ versículos leídos', '50K+ usuarios diarios', '10K+ hadices consultados', '1M+ horarios de oración consultados', '5M+ tasbih contados', '30K+ letras practicadas'], cta: { eyebrow: 'Da el siguiente paso', heading: '¿Te gustan estas herramientas? Aprende con un tutor certificado.', sub: 'Nuestras herramientas gratuitas son solo una muestra de lo que recibes con Al-Rahma Academy. Únete a clases individuales con tutores certificados por Al-Azhar y transforma tu aprendizaje del Corán.', bullets: ['Lección de prueba gratuita de 30 minutos — no se requiere pago', 'Programa personalizado para tu nivel', 'Tutoras disponibles para hermanas', 'Horarios flexibles, 24/7'], button: 'Reserva una lección de prueba gratuita', note: 'Sin tarjeta de crédito · Cancela cuando quieras · Respondemos en 2 horas', socialProof: 'Únete a más de 1.200 estudiantes que ya están aprendiendo' } },
  de: { badges: [{ label: '⭐ Am beliebtesten', cls: 'hub-badge--gold' }, null, null, { label: '🕌 Tägliche Nutzung', cls: 'hub-badge--green' }, null, { label: '🆕 Neu', cls: 'hub-badge--blue' }], stats: ['2 Mio.+ gelesene Verse', '50.000+ tägliche Nutzer', '10.000+ aufgerufene Hadithe', '1 Mio.+ geprüfte Gebetszeiten', '5 Mio.+ gezählte Tasbih', '30.000+ geübte Buchstaben'], cta: { eyebrow: 'Mach den nächsten Schritt', heading: 'Gefallen dir diese Tools? Lerne mit einer zertifizierten Lehrkraft.', sub: 'Unsere kostenlosen Tools sind nur ein kleiner Einblick in das Angebot der Al-Rahma Academy. Nimm Einzelunterricht bei Al-Azhar-zertifizierten Lehrkräften und gestalte deine Reise zum Koran neu.', bullets: ['30-minütige kostenlose Probestunde — keine Zahlung erforderlich', 'Persönlicher Lehrplan für dein Niveau', 'Lehrerinnen für Schwestern verfügbar', 'Flexible Terminplanung, rund um die Uhr'], button: 'Kostenlose Probestunde buchen', note: 'Keine Kreditkarte · Jederzeit kündbar · Antwort innerhalb von 2 Stunden', socialProof: 'Schließe dich über 1.200 Lernenden an' } },
  fr: { badges: [{ label: '⭐ Le plus populaire', cls: 'hub-badge--gold' }, null, null, { label: '🕌 Usage quotidien', cls: 'hub-badge--green' }, null, { label: '🆕 Nouveau', cls: 'hub-badge--blue' }], stats: ['2 M+ versets lus', '50 k+ utilisateurs quotidiens', '10 k+ hadiths consultés', '1 M+ horaires de prière consultés', '5 M+ tasbih comptés', '30 k+ lettres pratiquées'], cta: { eyebrow: 'Passez à l’étape suivante', heading: 'Vous aimez ces outils ? Apprenez avec un enseignant certifié.', sub: 'Nos outils gratuits ne sont qu’un aperçu de ce que vous offre Al-Rahma Academy. Rejoignez des cours individuels avec des enseignants certifiés par Al-Azhar et transformez votre apprentissage du Coran.', bullets: ['Cours d’essai gratuit de 30 minutes — aucun paiement requis', 'Programme personnalisé selon votre niveau', 'Enseignantes disponibles pour les sœurs', 'Horaires flexibles, 24 h/24 et 7 j/7'], button: 'Réserver un cours d’essai gratuit', note: 'Aucune carte bancaire · Annulez à tout moment · Réponse sous 2 heures', socialProof: 'Rejoignez plus de 1 200 élèves qui apprennent déjà' } },
};
