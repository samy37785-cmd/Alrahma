 ...
 * official artwork (photographed/rendered brand asset, not a hand-drawn
 * recreation) processed into two optimized web variants — see
 * docs/official-logo-integration.md for the full source-to-asset pipeline:
 *
 *   - transparent icon (public/brand/icon.{png,webp}) — the glyph alone,
 *     alpha-matted with the flat render background chroma-keyed out, for
 *     placements that already sit on a brand-dark-green surface (the header
 *     bar, BrandLockup's own card, the sidebar, the footer/auth brand mark).
 ...
 * every existing caller — BrandLockup, DashboardLayout, InvoiceModal — needs
 * no changes):
