const es = {
  ...
  "authPg": {
    ...
    "register": {
      ...
      "back": "← Volver al sitio",
      "gdprConsent": "Acepto la <a style=\"color:var(--green)\">Política de Privacidad</a> y consiento que Al-Rahma Academy procese mis datos personales para gestionar mi cuenta y las clases.",
  ...
  "teacherDash": {
    ...
    "noCourses": "Sin actividad aún.",
    "noHifz": "No se registró memorización.",
    "delete": "Eliminar",
    "close": "Cerrar",
  ...
  "parentDash": {
    ...
    "link": "Vincular",
    "linked": "Hijo vinculado con éxito.",
    "children": "Mis hijos",
    "noChildren": "Aún no hay hijos vinculados.",
    "records": "registros",
    "verses": "versículos memorizados",
    "view": "Ver progreso",
    "unlink": "Desvincular",
    "close": "Cerrar",
    "history": "Seguimiento del profesor",
    "noRecords": "Sin registros de seguimiento.",
    "courseProgress": "Progreso del curso",
    "hifz": "Memorización (Hifz)",
