...
export default function RefundPolicy() {
  ...
  const policies = {
    ar: {
        ...
        receiveRefundText: ' تتم معالجة طلبات الاسترداد المعتمدة خلال 5–10 أيام عمل وإعادتها بنفس الوسيلة التي دفعت بها.',
    ...
    en: {
        ...
        receiveRefundText:
          ' Approved refunds are processed within 5–10 business days, back through the same method you originally paid with.',
